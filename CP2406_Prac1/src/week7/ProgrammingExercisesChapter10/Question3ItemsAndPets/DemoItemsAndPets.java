package week7.ProgrammingExercisesChapter10.Question3ItemsAndPets;

public class DemoItemsAndPets {
    public static void main(String[] args) {
        ItemSold item1 = new ItemSold(1, "Cool item", 9);
        ItemSold item2 = new ItemSold(5, "Cooler item", 35);
        PetSold pet1 = new PetSold(2, "Doogo", 60, true, false, true);
        PetSold pet2 = new PetSold(3, "Cat", 50, false, true, true);
        item1.setPrice(45);
        item2.setDescription("Way cooler item");
        item1.setNumber(2);
