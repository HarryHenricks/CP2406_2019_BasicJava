...
public class CarCareChoice2 {
    public static void main(String[] args) {
        String[] stringArray = {"oil change", "tire rotation", "battery check", "break inspection"};
        int[] intArray = {25, 22, 15, 5};
        int correctIndex = -1;
        Scanner input = new Scanner(System.in);
        System.out.println("Please enter first 3 letters of the following strings to choose: \n" + stringArray[0] + "\n" + stringArray[1] + "\n"+ stringArray[2] + "\n"+ stringArray[3] + "\n");
